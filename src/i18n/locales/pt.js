export default {
  ...
  publications: {
    ...
    entries: {
      ...
      'springer-2025': {
        title: 'Compreendendo Fatores Escolares Relacionados ao Absenteísmo de Estudantes em Escolas Públicas Brasileiras: Insights para Políticas Educacionais Através de uma Abordagem de Clustering',
