  ...
  publications: {
    ...
    entries: {
      'nature-2025': {
        ...
        description: 'Aplicação de técnicas avançadas de ML (Random Forest, XGBoost) para otimizar a predição de risco de evasão a partir de dados de log do Moodle.',
      },
      'springer-2025': {
